                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3 card">
                                        <div class="card-header-tab card-header-tab-animation card-header"> 
                                            <h5 class="card-title mt-3">Kateqoriya əlavə etmək</h5>
                                            <ul class="nav">
                                        ...
                                        <div class="card-body">
                                            <form method="post" action="{{ route('categories.store') }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="tab-eg8-0" role="tabpanel"><textarea name="category_az" id="category_az" class="form-control"></textarea></div>
                                                    <div class="tab-pane" id="tab-eg8-1" role="tabpanel"><textarea name="category_ru" id="category_ru" class="form-control"></textarea></div>
                                                    <div class="tab-pane" id="tab-eg8-2" role="tabpanel"><textarea name="category_en" id="category_en" class="form-control"></textarea></div>
                                                </div>
                                                <br>
                                ...
                                <div class="col-md-6">
                                    <div class="main-card mb-3 card">
                                        <div class="card-body table-responsive"><h5 class="card-title">Əlavə edilən kateqoriyalar</h5>
