							...
							<div class="row">
								<div class="col-md-6">
									<div class="mb-3 card">
										<div class="card-header-tab card-header-tab-animation card-header">
											<div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="header-icon lnr-gift icon-gradient bg-love-kiss"></i>Redaksiya şurası üzvü əlavə etmək</div>
											<ul class="nav">
										...
										<div class="card-body">
											<form method="post" action="{{ route('editorialCouncil.store') }}" enctype="multipart/form-data">
												@csrf
												<div class="position-relative form-group"><label for="editor_photo" class="">Şəkil</label><input name="editor_photo" id="editor_photo" type="file" class="form-control-file"/>
													<small class="form-text text-muted">Şura üzvü şəklini əlavə edin</small>
												</div>
												<div class="tab-content">
								...
								<div class="col-md-6">
									<div class="main-card mb-3 card">
										<div class="card-body table-responsive"><h5 class="card-title">Əlavə edilən şura üzvləri</h5>
