                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>
                                    <div>Linkdə dəyişiklik etmək
                                        <div class="page-title-subheading">
                                            Editing the link / Редактировать ссылку
                                        </div>
                                    </div> 
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Linkdə dəyişiklik etmək</h5><hr>
                                        <form method="post" action="{{ route('links.update', $link->id) }}" enctype="multipart/form-data">
                                            @method('PATCH')
                                            @csrf
                                            <div class="position-relative form-group"><label for="link_url" class="">Link URL qeyd edin</label><input name="link_url" id="link_url" placeholder="məsələn: http://socar.az" type="text" class="form-control" value="{{ $link->link_url }}" required=""></div>
                                            <div class="position-relative form-group"><label for="image_url" class="">Şəkil</label><input name="image_url" id="image_url" type="file" class="form-control-file"/>
                                                ...
                                                <br>
                                                <img width="200px" src="/{{ $link->image_url }}">
                                            </div>
