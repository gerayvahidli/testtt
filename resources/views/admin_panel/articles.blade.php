                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                                            <h5 class="card-title">Məqalə əlavə etmək</h5>
                                            <hr>
                                            <form method="post" action="{{ route('articles.store') }}" enctype="multipart/form-data">
                                                @csrf

                                                <input type="hidden" name="abstractAz" value="">
                                                <input type="hidden" name="abstractRu" value="">
                                                <input type="hidden" name="abstractEn" value="">
                                                <input type="hidden" name="referencesAz" value="">
                                                <input type="hidden" name="referencesRu" value="">
                                                <input type="hidden" name="referencesEn" value="">

                                                <input type="hidden" id="authorsAz" name="authorsAz" value="">
                                                <input type="hidden" id="authorsRu" name="authorsRu" value="">
                                                <input type="hidden" id="authorsEn" name="authorsEn" value="">
                                                ...
                                                <div class="position-relative form-group">
                                                    ...
                                                    <select type="select" id="journal_id" name="journal_id" class="custom-select">
                                                        ...
                                                        <!-- <option>{{ $journal->month }}, {{ $journal->year }}</option> -->
                                                ...
                                                <div class="position-relative form-group"><label for="page_num" class="">Səhifələr</label><input name="page_num" id="page_num" placeholder="məsələn: 57-59" type="text" class="form-control" required=""></div>
                                                <div class="position-relative form-group"><label for="UOT_code" class="">UOT Code</label><input name="UOT_code" id="UOT_code" placeholder="məsələn: 12.34.567.890" type="text" class="form-control" required=""></div>
                                                <div class="position-relative form-group"><label for="DOI_code" class="">DOI Code</label><input name="DOI_code" id="DOI_code" placeholder="məsələn: 10.24887/0028-2448-2020-7-16-20" type="text" class="form-control" required=""></div>
                                                <div class="position-relative form-group">
                                                    ...
                                                    <select type="select" id="category_id" name="category_id" class="custom-select">
                                                        ...
                                                        <option value="{{ $category->id }}">{{ $category->categoryAz }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane active" id="tab-eg8-0" role="tabpanel">
                                                        ...
                                                        <div style="padding: 1em;background-color: wheat;">
                                                            ...
                                                            <div class="position-relative form-group"><label for="newAuthorNameAz" class="">Müəllifin adı</label>
                                                                <input onfocus="this.value=''" id="newAuthorNameAz" type="text" class="form-control">
                                                            </div>
                                                            <div class="position-relative form-group">
                                                        ...
                                                        <div class="position-relative form-group"><label for="titleAz" class="">Məqalənin başlığı</label><input name="titleAz" id="titleAz" placeholder="" type="text" class="form-control" required=""></div>
                                                        <div class="position-relative form-group"><label for="keywordsAz" class="">Açar sözlər</label><input name="keywordsAz" id="keywordsAz" placeholder="məsələn: temperatur, hövzə, çöküntü örtüyü" type="text" class="form-control" required=""></div>

                                                        <div class="position-relative form-group"><label for="editor1" class="">Qısa xülasə</label>
                                                            <div class="centered">
                                                                <div id="editor1">
                                                        ...
                                                        <div class="position-relative form-group"><label for="editor2" class="">Ədəbiyyat siyahısı</label>
                                                            <div class="centered">
                                                                <div id="editor2">
                                                    ...
                                                    <div class="tab-pane" id="tab-eg8-1" role="tabpanel">
                                                        ...
                                                        <div class="position-relative form-group"><label for="titleRu" class="">Заголовок статьи</label><input name="titleRu" id="titleRu" placeholder="" type="text" class="form-control" required=""></div>
                                                        <div class="position-relative form-group"><label for="keywordsRu" class="">Ключевые слова</label><input name="keywordsRu" id="keywordsRu" placeholder="например: а, б, в" type="text" class="form-control" required=""></div>

                                                        <div class="position-relative form-group"><label for="editor3" class="">Краткое содержание</label>
                                                            <div class="centered">
                                                                <div id="editor3">
                                                        ...
                                                        <div class="position-relative form-group"><label for="editor4" class="">Список литературы</label>
                                                            <div class="centered">
                                                                <div id="editor4">
                                                    ...
                                                    <div class="tab-pane" id="tab-eg8-2" role="tabpanel">
                                                        ...
                                                        <div class="position-relative form-group"><label for="titleEn" class="">Article title</label><input name="titleEn" id="titleEn" placeholder="" type="text" class="form-control" required=""></div>
                                                        <div class="position-relative form-group"><label for="keywordsEn" class="">Keywords</label><input name="keywordsEn" id="keywordsEn" placeholder="for example: a,b,c" type="text" class="form-control" required=""></div>

                                                        <div class="position-relative form-group"><label for="editor5" class="">Abstract</label>
                                                            <div class="centered">
                                                                <div id="editor5">
                                                        ...
                                                        <div class="position-relative form-group"><label for="editor6" class="">References list</label>
                                                            <div class="centered">
                                                                <div id="editor6">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('articles.destroy', $article->id)}}" method="post">
                                                              @csrf
                                                              @method('DELETE')
                                                              <button class="btn btn-danger" id="del_{{$article->id}}" onclick= "return confirm('Bu məqaləni silmək istəyirsiz?')" type="submit">Silmək</button>
                                                          </form>
                                                      </td>
                                                  </tr>
                                                  @endforeach
