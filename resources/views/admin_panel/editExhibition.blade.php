                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>
                                    <div>Sərgidə dəyişiklik etmək
                                        <div class="page-title-subheading">
                                            Editing the exhibition / Редактировать выставку
                                        </div>
                                    </div> 
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Sərgidə dəyişiklik etmək</h5><hr>
                                        <form method="post" action="{{ route('exhibitions.update', $exhibition->id) }}" enctype="multipart/form-data">
                                            @method('PATCH')
                                            @csrf
                                            <div class="position-relative form-group"><label for="exhibition_url" class="">Sərgi URL qeyd edin</label><input name="exhibition_url" id="exhibition_url" placeholder="məsələn: http://socar.az" type="text" class="form-control" value="{{ $exhibition->exhibition_url }}" required=""></div>
                                            <div class="position-relative form-group"><label for="image_url" class="">Şəkil</label><input name="image_url" id="image_url" type="file" class="form-control-file"/>
                                                <small class="form-text text-muted">Sərginin üz şəklini dəyişmək</small>
                                                <br>
                                                <img width="200px" src="/{{ $exhibition->image_url }}">
                                            </div>
