                                ...
                                <div class="col-md-6">
                                    <div class="main-card mb-3 card">
                                                <div class="card-header-tab card-header-tab-animation card-header"> 
                                                    <h5 class="card-title mt-3">Bölmə əlavə etmək</h5>
                                                    <ul class="nav">
                                        ...
                                        <div class="card-body">
                                            <form method="post" action="{{ route('mainPage.store') }}" enctype="multipart/form-data">
                                                @csrf

                                                <input type="hidden" name="contentAz" value="">
                                                <input type="hidden" name="contentRu" value="">
                                                <input type="hidden" name="contentEn" value="">

                                                <div class="tab-content">
                                                    <!-- AZERBAIJANI -->
                                                    <div class="tab-pane active" id="tab-eg8-0" role="tabpanel">
                                                        <div class="position-relative form-group"><label for="titleAz" class="">Bölmənin başlığı</label><input name="titleAz" id="titleAz" placeholder="" type="text" class="form-control" required=""></div>
                                                    ...
                                                    <div class="tab-pane" id="tab-eg8-1" role="tabpanel">
                                                        <div class="position-relative form-group"><label for="titleRu" class="">Заголовок</label><input name="titleRu" id="titleRu" placeholder="" type="text" class="form-control" required=""></div>
                                                    ...
                                                    <div class="tab-pane" id="tab-eg8-2" role="tabpanel">
                                                        <div class="position-relative form-group"><label for="titleEn" class="">Title</label><input name="titleEn" id="titleEn" placeholder="" type="text" class="form-control" required=""></div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('mainPage.destroy', $mainPageBlock->id)}}" method="post">
                                                              @csrf
                                                              @method('DELETE')
                                                              <button class="btn btn-danger" id="del_{{$mainPageBlock->id}}" onclick= "return confirm('Are You Sure Want to Delete?')" type="submit">Silmək</button>
                                                          </form>
                                                      </td>
                                                  </tr>
                                                  @endforeach
